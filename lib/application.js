...
class MutantTestGenApplication {
  ...
  async generateTests(options) {
    const {
      sourcePath,
      outputPath,
      useFeedbackLoop = this.config.useFeedbackLoop,
      targetMutationScore = this.config.targetMutationScore,
      maxIterations = this.config.maxIterations,
      runMutationAnalysis = this.config.runMutationAnalysis, // Use config default
      llmOptions = {},
      mutationOptions = {}
    } = options;
